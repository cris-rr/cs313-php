...
<head>
  ...
  <link rel="shortcut icon" <? echo "href='$rootPath/images/site/buddy32.png'" ?> type="image/x-icon">
  <link rel="stylesheet" <? echo "href='$rootPath/css/main.css'" ?>>
...
<body class="pageHome">
  ...
  <main>
    ...
    <section class="summary">
      ...
      <p><span class="subtitle2">Buddy who owes me more: </span>
